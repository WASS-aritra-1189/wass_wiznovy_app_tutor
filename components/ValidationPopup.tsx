...
import AccountReviewPopup from './AccountReviewPopup';
...
const ValidationPopup: React.FC<ValidationPopupProps> = ({ visible, onConfirm, loading = false }) => {
          ...
          <View style={styles.modalContent}>
            ...
            <View style={styles.imageContainer}>
              <View style={styles.iconContainer}>
                <MaterialIcons name="verified-user" size={100} color="#16423C" />
              </View>
            </View>
            
            {/* Header */}
            <Text style={styles.modalTitle}>WE ARE VALIDATING YOUR INFORMATION</Text>
            ...
            <TouchableOpacity 
              ...
              style={[styles.confirmButton, (!accepted || loading) && styles.confirmButtonDisabled]}
